...
const Achievements = () => {
  ...
  const platforms = [
    {
      ...
      username: "7ose",
      profile: "https://app.hackthebox.com/profile/7ose",
      stats: [
    ...
    },
    {
      ...
      username: "crumpledflowers",
      profile: "https://tryhackme.com/p/crumpledflowers",
      stats: [
    ...
    },
    {
      ...
      username: "your_team",
      profile: "https://ctftime.org/team/your_team",
      stats: [
  ...
  return (
    <section id="achievements" className="min-h-screen py-20 relative" ref={sectionRef}>
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="terminal text-4xl md:text-5xl font-bold text-foreground mb-4">
            ...
            >
              <AdvancedCard
                ...
                style={{
                  ...
                  boxShadow: hoveredCard === index ? `0 0 20px hsl(var(--primary) / 0.3)` : "none",
                  borderColor: hoveredCard === index ? `hsl(var(--primary) / 0.5)` : "hsl(var(--border))",
                }}
              >
                ...
                <motion.div
                  ...
                  animate={{
                    background:
                      hoveredCard === index
                        ? `radial-gradient(circle at 50% 50%, ${platform.color} 0%, transparent 70%)`
                ...
                <CardHeader className="pb-4 flex flex-row items-center justify-between">
                  <div className="flex items-center gap-3">
                    <motion.div
                      className="h-10 w-10 rounded-md p-1 flex items-center justify-center overflow-hidden bg-background"
                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    {platform.stats.map((stat, i) => (
                      <motion.div
                        key={i}
                        className="bg-background/30 p-3 rounded-md relative overflow-hidden"
                        whileHover={{
                          scale: 1.05,
                          transition: { duration: 0.2 },
                        }}
